 ...
 *
 * @author arace
 * La interfaz iManagerEntrega define métodos para gestionar el proceso de entrega.
 * Permite crear una entrega, obtener y establecer el servicio, el transporte, el paquete
 * y la distancia, calcular el costo y el tiempo estimado de la entrega.
 */
public interface iManagerEntrega {

    /**
     * Método para crear una entrega con el servicio, la distancia y el tipo de paquete especificados.
