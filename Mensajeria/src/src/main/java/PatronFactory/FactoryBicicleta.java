 ...
 * 
 * Implementa el patrón Factory para crear objetos de tipo Bicicleta.
 * Forma parte del patrón Factory Method, que permite crear diferentes tipos de transportes
