 ...
 *
 * @author arace
 * La clase IteradorEntrega implementa la interfaz iPatronIterador para iterar sobre una secuencia de elementos relacionados con una entrega.
 */
public class IteradorEntrega implements iPatronIterador {
    ...
    /**
     * Constructor de la clase IteradorEntrega.
     * Inicializa la colección con los elementos asociados a una entrega y el índice a cero.
     * @param entrega La entrega de la cual se extraen los elementos para la iteración.
     */
