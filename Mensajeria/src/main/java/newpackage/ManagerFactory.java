...
/**
 * @author arace
 * La clase ManagerFactory implementa la interfaz iFactoryManager y se utiliza para crear diferentes tipos de objetos como paquetes, servicios y transportes.
 */
public class ManagerFactory implements iFactoryManager {
    ...
    /**
     * Constructor de la clase ManagerFactory.
     * Inicializa las diferentes fábricas y servicios.
     */
