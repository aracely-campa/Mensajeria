 ...
 * Estos métodos permiten establecer diferentes aspectos de una entrega, como el servicio,
 * el medio de transporte, el tipo de paquete, el costo adicional, la distancia, el tiempo estimado, etc.
 */
public interface iBuilderEntrega {
    ...
    /**
     * Método para restaurar el estado del constructor de entrega.
     * Esto puede ser útil para reiniciar la construcción de una entrega desde cero.
     */
