 ...
 *
 * @author arace
 * La clase Entrega representa un objeto que contiene información sobre
 * un servicio de entrega, incluido el tipo de servicio, el transporte utilizado,
 * el tipo de paquete, la distancia a recorrer, el costo final y el tiempo estimado de llegada.
 */
public class Entrega {
    ...
    /**
     * Constructor de la clase Entrega que inicializa los atributos con valores proporcionados.
    ...
    /**
     * Método toString que devuelve una representación en cadena del objeto Entrega.
